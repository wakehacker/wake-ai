...
class ClaudeCodeSession:
    ...
    async def _handle_result_with_auto_compact(
        ...
        """Handle result and auto-compact if needed."""
    ...
    async def query_async(
        ...
        resume_session: Optional[
            str
        ] = None,  # put sesision id when continue or reusme the sesison.
        ...
        options = ClaudeCodeOptions(
            ...
            cwd=str(
                self.execution_dir
            ),  # Use working_dir for SDK since it's the scratch space
    ...
    def query_with_cost(
        ...
        response = asyncio.run(
            self.query_async(
                prompt=prompt,
                max_turns=turn_step,
                # this will continue true for always.
