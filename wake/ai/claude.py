...
class ClaudeCodeSession:
    ...
    def _build_command(
        ...
        if not non_interactive and prompt:
            cmd.append(prompt)
    ...
    def start_interactive(self, initial_prompt: Optional[str] = None) -> subprocess.Popen:
        ...
        Returns:
            Popen process object for the interactive session
        """
        cmd = self._build_command(
